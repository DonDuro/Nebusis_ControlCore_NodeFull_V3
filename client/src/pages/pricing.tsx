        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-slate-800">Nebusis® ControlCore</h1>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
            {t('pricing.heroTitle')}
            <span className="text-blue-600 block">{t('pricing.heroSubtitle')}</span>
          </h1>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <div className="space-y-6 mb-8">
              <div className="bg-blue-50 p-6 rounded-lg">
                <h4 className="text-lg font-semibold text-blue-900 mb-3">{t('pricing.baseCosts')}</h4>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-white p-4 rounded border-l-4 border-blue-500">
                    <p className="font-semibold text-gray-900">{t('pricing.initialConfiguration')}</p>
                    <p className="text-2xl font-bold text-blue-600">{t('pricing.initialConfigurationPrice')}</p>
                  ...
                  <div className="bg-white p-4 rounded border-l-4 border-blue-500">
                    ...
                    <p className="text-2xl font-bold text-blue-600">{t('pricing.annualLicensePrice')}</p>
            ...
            <Button 
              size="lg" 
              className="bg-blue-600 hover:bg-blue-700 px-8 py-3 w-full"
            ...
            <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 to-blue-100">
              ...
              <CardContent className="space-y-4">
                <div className="bg-white p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-600 mb-2">{t('pricing.scopeBasic')}</h4>
                  <p className="text-sm text-gray-600">{t('pricing.scopeBasicDescription')}</p>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-600 mb-2">{t('pricing.scopeIntermediate')}</h4>
                  <p className="text-sm text-gray-600">{t('pricing.scopeIntermediateDescription')}</p>
                </div>
                <div className="bg-white p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-600 mb-2">{t('pricing.scopeAdvanced')}</h4>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            {/* Extended Tier */}
            <Card className="border-2 border-blue-300 relative shadow-xl scale-105">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <Badge className="bg-blue-600 text-white px-4 py-1">{t('pricing.mostPopular')}</Badge>
              </div>
              <CardHeader className="text-center">
                <Badge variant="default" className="w-fit mx-auto mb-4 bg-blue-600">{t('pricing.extendedTier')}</Badge>
              ...
              <CardContent className="space-y-4">
                ...
                <Button className="w-full mt-6 bg-blue-600 hover:bg-blue-700" onClick={openSalesForm}>
                  {t('pricing.requestQuote')}
                </Button>
              </CardContent>
            </Card>
