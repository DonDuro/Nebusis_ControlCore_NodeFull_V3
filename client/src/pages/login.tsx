...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dr-bg via-blue-50 to-green-50 flex items-center justify-center p-4">
        ...
        <div className="hidden lg:flex flex-col items-center justify-center space-y-8 p-8">
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-xl text-dr-neutral">
                {t('branding.tagline')}
              </p>
          ...
          <div className="w-full max-w-lg space-y-6">
            <div className="relative">
              <div className="w-full bg-gradient-to-br from-blue-50 to-green-50 rounded-lg shadow-lg p-8 border">
