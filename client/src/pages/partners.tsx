    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-gray-50">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              >
                ...
                <rect x="8" y="28" width="20" height="4" fill="white" />
              </svg>
              <div className="text-left">
                <h1 className="text-lg font-bold text-gray-900">{t('partners.pageTitle')}</h1>
              </div>
            </div>
            <LanguageToggle />
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-100 text-blue-800 text-sm font-medium mb-8">
            ...
            {t('partners.collaborationOpportunities')}
          </div>
          <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
            {t('partners.joinTitle')}
            <span className="text-blue-600 block">{t('partners.partnerProgram')}</span>
          </h1>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-gray-50 p-8 rounded-lg shadow-xl">
