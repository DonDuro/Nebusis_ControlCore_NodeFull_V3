          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
              ...
              <div className="flex gap-3 mt-4 sm:mt-0">
                <Button onClick={() => navigate("/workflows")} className="bg-blue-600 hover:bg-blue-700">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-3">
                    <button 
                      ...
                      className="group flex items-center space-x-3 p-3 rounded-lg border-2 border-gray-200 hover:border-blue-500 hover:bg-blue-50 transition-all duration-200"
                    >
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                      <div>
                        <div className="font-semibold text-blue-800">{t('dashboard.activeWorkflows')}</div>
                        <div className="text-sm text-blue-600">{t('dashboard.inProgress')}</div>
                      </div>
                      <div className="text-2xl font-bold text-blue-700">{statsData.activeWorkflows}</div>
                    </div>
