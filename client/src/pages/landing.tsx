          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">{t('branding.tagline')}</p>
              </div>
            </div>
          ...
          <div className="mx-auto w-full max-w-md lg:max-w-lg">
            ...
            <div className="mb-8">
              ...
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 leading-tight mb-4">
                {t('landing.subtitle')} <span className="text-blue-600">{t('landing.platform')}</span>
              </h1>
        ...
        <div className="hidden lg:block relative w-0 flex-1">
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center">
            <div className="text-center text-white px-8">
              ...
              <h2 className="text-3xl font-bold mb-4">{t('branding.productName')}</h2>
              ...
              <div className="space-y-4 text-left max-w-sm mx-auto">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-blue-100">{t('coso.components.controlEnvironment')}</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-white rounded-full flex-shrink-0"></div>
                  <span className="text-blue-100">{t('coso.components.riskAssessment')}</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-white rounded-full flex-shrink-0"></div>
                  <span className="text-blue-100">{t('coso.components.controlActivities')}</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-white rounded-full flex-shrink-0"></div>
                  <span className="text-blue-100">{t('coso.components.informationCommunication')}</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-white rounded-full flex-shrink-0"></div>
                  <span className="text-blue-100">{t('coso.components.monitoring')}</span>
                </div>
              </div>
            </div>
          </div>
