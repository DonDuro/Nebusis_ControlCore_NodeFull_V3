      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
            {t('about.title')}
            <span className="text-blue-600 block">{t('about.titleHighlight')}</span>
          </h1>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="border-2 border-blue-300 bg-blue-50 hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="flex items-center justify-between mb-2">
                  <CheckCircle className="h-6 w-6 text-blue-600" />
                  <Badge className="bg-blue-600 text-white">{t('about.availableNow')}</Badge>
                </div>
              ...
              <CardContent>
                ...
                <Button className="w-full bg-blue-600 hover:bg-blue-700" onClick={() => window.location.href = "/features"}>
