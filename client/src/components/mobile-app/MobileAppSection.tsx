  ...
  return (
    <div className="flex flex-col items-center space-y-2">
      <img 
        ...
        className="w-32 h-32 border-2 border-blue-600 rounded-lg shadow-lg"
      />
...
export default function MobileAppSection({ className = "" }: MobileAppSectionProps) {
  ...
  return (
    <>
      ...
      <section className={`mobile-app-section py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 via-white to-indigo-50 ${className}`} id="mobile-app">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
                  ...
                  <span className="text-blue-600 block">App Móvil</span>
                </h2>
